...
# Use package-relative imports because settings.py, security.py, etc. are in the same 'app' package.
...
# Initialize storage and schema at startup
init_engine()
create_schema()
...
def results_page():
    ...
    full_rows = [
        {'id': m['id'], 'category': m['category'], 'name': m['name'], 'value': random.choice(['OK', 'Warning', 'Error', 'Improvement'])}
        for m in catalogue
    ]
