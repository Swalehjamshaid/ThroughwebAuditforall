...
def open_audit():
    ...
    site_health_stub = stub.get('site_health', {})
    site_health = {
        'score': score,
        'errors': site_health_stub.get('errors', 0),
        'warnings': site_health_stub.get('warnings', 0),
        'notices': site_health_stub.get('notices', 0),
        'grade': grade
    }
    results = {
