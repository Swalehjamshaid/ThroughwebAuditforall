...
# Category-wise scoring using simple weighted demo algorithm
CATEGORY_WEIGHTS = {
...
# Registered audit: generate full rows (140 metrics)
...
# Compute category scores from rows

def compute_category_scores(full_rows):
    # Simple mapping: OK=1, Improvement=0.7, Warning=0.3, Error=0
    ...
    # Fill missing categories with mid values
