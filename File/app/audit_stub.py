...
def stub_open_metrics(url):
    ...
    return {
        'site_health': {
            'score': score,
            'errors': random.randint(0, 25),
            'warnings': random.randint(5, 60),
            'notices': random.randint(10, 100),
            'grade': grade
        },
        'highlights': [
            'Missing alt texts on several images',
            'Unminified CSS/JS increasing load time',
            'Potential redirect chain detected',
        ...
        'recommendations': [
            ...
            'Enable GZIP/Brotli and browser caching'
        ]
    }
