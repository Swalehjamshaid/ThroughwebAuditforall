...
def generate_summary(url, site_health, category_scores):
    ...
    summary = (f"This comprehensive audit of {url} evaluates technical health, crawlability, on-page SEO, performance, security, mobile usability, and international readiness. "
