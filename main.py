...
# ==================== REAL & ACCURATE SCORING (Based on 2025 Google Thresholds) ====================
...
async def audit(request: Request):
    ...
    scores = {
        ...
        "Time to First Byte (ms)": score_range(ttfb, 800, 2000),
    ...
    summary = f"LCP {perf['lcp']:.0f}ms | CLS {perf['cls']:.2f} | TBT {perf['tbt']:.0f}ms | Weight {analysis['page_weight_kb']:.0f}KB"
