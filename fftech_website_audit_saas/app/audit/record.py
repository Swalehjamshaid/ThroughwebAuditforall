...
def export_graph(audit_id: int, category_scores: dict, out_dir: str) -> str:
...
def export_pptx(audit_id: int, png_path: str, metrics: dict, out_dir: str) -> str:
    os.makedirs(out_dir, exist_ok=True)
    ...
    slide.shapes.add_picture(png_path, Inches(1), Inches(1.2), width=Inches(8))
